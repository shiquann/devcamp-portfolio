#creating sample data to use in app
#rails db:setup uses this but delets all of the user data never use in production 

top = ["Software Engineer","Other", "Ruby on Rails"]
3.times do |topic|
    Topic.create!(
        title: top[topic]
    )
